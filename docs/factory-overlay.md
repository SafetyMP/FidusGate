# Site contract overlay

Internal factory/site overlay for `site_id: fidusgate`. Community agents start at [`AGENTS.md`](../AGENTS.md). Do not treat this file as the public product contract.
...
Do **not** put Docker or integration smoke inside `verify.sh`. Child green in a worktree does not imply main-stack green — see [`docs/harness/false-green-checklist.md`](harness/false-green-checklist.md).
